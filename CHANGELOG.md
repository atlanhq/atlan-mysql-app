...
## v2.2.1 (September 11, 2026)

Full Changelog: https://github.com/atlanhq/atlan-mysql-app/compare/v2.2.0...v2.2.1
...
- hand the transformed tree to publish by reference, not by directory scan (#628) (by @cmgrote in [23c3d98](https://github.com/atlanhq/atlan-mysql-app/commit/23c3d98))
- type every failed check and return PARTIAL on a MySQL transient (#621) (by @fyzanshaik-atlan in [977bbe4](https://github.com/atlanhq/atlan-mysql-app/commit/977bbe4))
...
## v2.0.4 (August 04, 2026)

Full Changelog: https://github.com/atlanhq/atlan-mysql-app/compare/v2.0.3...v2.0.4
...
- expose aws_external_id in iam_role auth (#158) (by @vaibhavatlan in [d3b0e94](https://github.com/atlanhq/atlan-mysql-app/commit/d3b0e94))
...
- **Re-pin `atlan-application-sdk` → SHA `710ad447`** to pick up the post-review refactor of `prime_sql_auth` and three follow-up reviewer fixes ([application-sdk#1835](https://github.com/atlanhq/application-sdk/pull/1835)). Changes in this bump:
