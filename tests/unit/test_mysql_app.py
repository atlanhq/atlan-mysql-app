...
class TestMySQLAppClassAttrs:
    ...
    def test_information_schema_placeholder_present_in_ddl_sql(self):
        ...
        or a customer-provided mirror schema."""
        for attr in [
            "fetch_database_sql",
            "fetch_schema_sql",
            "fetch_table_sql",
    ...
    def test_run_parses_control_config_from_pydantic_input(self):
        """internal-ref regression: pydantic-v2 default ``extra='ignore'`` was
    ...
    def test_build_task_input_threads_control_config_to_task(self):
        """internal-ref regression: control-config must travel ON the task input
    ...
    def test_extract_task_signatures_use_mysql_subclass(self):
        """internal-ref regression: the @task method annotations must declare
...
class TestMaterializeMirrorIntoInput:
    """internal-ref follow-up: ``_materialize_mirror_into_input(creds, input)``
...
class TestInitSqlClientMaterializesMirror:
    """internal-ref follow-up: ``_init_sql_client`` (activity-context override)
